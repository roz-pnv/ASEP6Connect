    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country_of_origin', models.ForeignKey(help_text="User's country of origin", on_delete=django.db.models.deletion.PROTECT, to='users.country')),
            ],
            options={
                'verbose_name': 'User',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-start_date'],
                'indexes': [models.Index(fields=['user'], name='users_board_user_id_88f6b6_idx'), models.Index(fields=['role_type'], name='users_board_role_ty_5a555e_idx'), models.Index(fields=['start_date'], name='users_board_start_d_0db47a_idx'), models.Index(fields=['end_date'], name='users_board_end_dat_cff702_idx'), models.Index(fields=['is_suspended'], name='users_board_is_susp_6c0b13_idx')],
